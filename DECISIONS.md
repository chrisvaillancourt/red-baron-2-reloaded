...
## D-XXX — Single composition point for subsystems (game layer)
...
## D-XXX — Mouse-aim "instructor" is the default mouse mode
...
## D-XXX — Kill confirmation inputs and end-flight rules
