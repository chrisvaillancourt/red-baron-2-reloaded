...
## D-XXX — Controllers invert the pitch law through the tail's slipstream (ai-sim wave 5)
...
## D-XXX — Low-level defence: energy-aware g, faster recovery, level breaks; scissors rejected (ai-sim wave 5)
...
## D-XXX — Wounds before deaths; fewer splinter fires; dodge falling wrecks (ai-sim wave 5)
...
## D-XXX — Mouse-aim fine aiming and a separate instructor stall margin (ai-sim wave 5)
...
## D-XXX — Strafers leave early and keep ammunition; RTB flights fight back (ai-sim wave 5)
