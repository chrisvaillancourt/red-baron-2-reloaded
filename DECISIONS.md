...
## D-XXX — HUD declutter by priority, waypoint on the heading tape (hud-flight)
...
## D-XXX — Tracer streaks use eye persistence through the camera (hud-flight)
...
## D-XXX — Fokker E.III handling left as is; benchmark made multi-start (hud-flight)
