...
## D-XXX — Mouse-aim flies through the AI's model-inverse autopilot (polish-flight)
...
## D-XXX — Spotting dots for distant aircraft (polish-flight)
...
## D-XXX — Render-state interpolation between sim steps (polish-flight)
...
## D-XXX — Ground bounce on aircraft materials (polish-flight)
