...
export const WAR_PERIODS: { from: string; title: string; text: string }[] = [
  ...
  { from: '1917-01-01', title: 'The Albatros Ascendancy', text: 'Twin-gunned Albatros scouts outclass the Allied machines. Richthofen forms Jasta 11 at Douai.' },
  ...
  { from: '1917-06-01', title: 'Third Ypres', text: 'S.E.5a and Camel reach the front; the Flying Circus prowls Flanders. Over Passchendaele the sky is contested daily.' },
  { from: '1917-11-20', title: 'Cambrai', text: 'Tanks break the Hindenburg Line; low-flying scouts strafe trenches in fog and rain. The Fokker Dr.I appears in numbers.' },
