...
const SHOTS = [
  ...
  // Low-level (30–300 m) set: trenches, wire, no-man's-land, ruins, aerodromes.
  { name: 'low-somme-40', q: 'town=Pozi%C3%A8res&alt=40&pitch=-6&yaw=90&date=1916-09-15&tod=morning&cover=0.3&back=900' },
  { name: 'low-somme-120', q: 'town=Pozi%C3%A8res&alt=120&pitch=-14&yaw=90&date=1916-09-15&tod=afternoon&cover=0.3&back=1200' },
  { name: 'low-ypres-60', q: 'town=Passchendaele&alt=60&pitch=-8&yaw=60&date=1917-10-25&tod=midday&cover=0.6&back=2200' },
  { name: 'low-arras-80', q: 'town=Vimy&alt=80&pitch=-8&yaw=100&date=1917-05-10&tod=morning&cover=0.3&back=1200' },
  { name: 'low-ruins-60', q: 'town=Bapaume&alt=60&pitch=-10&date=1917-03-25&tod=afternoon&cover=0.3&back=700' },
  { name: 'low-road-50', q: 'town=Doullens&alt=50&pitch=-6&yaw=90&date=1917-06-01&tod=midday&cover=0.3&back=600' },
  { name: 'low-aero-30', q: 'town=Douai&alt=30&pitch=-4&yaw=250&date=1917-04-20&tod=morning&cover=0.3&back=3500' },
  { name: 'low-cambrai-200', q: 'town=Cambrai&alt=200&pitch=-10&yaw=270&date=1917-11-22&tod=midday&cover=0.3&back=-6000' },
  { name: 'dbg-ypres-noroads', q: 'town=Passchendaele&alt=60&pitch=-8&yaw=60&date=1917-10-25&tod=midday&cover=0.6&back=2200&hide=roads' },
  { name: 'dbg-ypres-notowns', q: 'town=Passchendaele&alt=60&pitch=-8&yaw=60&date=1917-10-25&tod=midday&cover=0.6&back=2200&hide=rivers' },
