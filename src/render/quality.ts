...
export const QUALITY: Record<GraphicsQuality, QualityPreset> = {
  low: {
    pixelRatioCap: 1, terrainMaxLevel: 8, terrainSplit: 1.3, terrainCache: 350, maskResolution: 100,
  ...
  medium: {
    pixelRatioCap: 1.25, terrainMaxLevel: 9, terrainSplit: 1.5, terrainCache: 500, maskResolution: 70,
  ...
  high: {
    pixelRatioCap: 1.5, terrainMaxLevel: 9, terrainSplit: 1.9, terrainCache: 700, maskResolution: 50,
  ...
  ultra: {
    pixelRatioCap: 2, terrainMaxLevel: 10, terrainSplit: 2.1, terrainCache: 1000, maskResolution: 40,
